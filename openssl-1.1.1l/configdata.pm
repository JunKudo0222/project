...
our %config = (
  ...
  LDFLAGS => [  ],
  LDLIBS => [  ],
  PERL => "/home/rs/perl/5.32/bin/perl",
  RANLIB => "ranlib",
  RC => "windres",
  RCFLAGS => [  ],
  afalgeng => "",
  ...
  openssldir => "/home/azurefennec478/usr/local/openssl1.1.1l",
  options => "--prefix=/home/azurefennec478/usr/local/openssl1.1.1l --openssldir=/home/azurefennec478/usr/local/openssl1.1.1l no-afalgeng no-asan no-buildtest-c++ no-crypto-mdebug no-crypto-mdebug-backtrace no-ec_nistp_64_gcc_128 no-egd no-external-tests no-fuzz-afl no-fuzz-libfuzzer no-heartbeats no-md2 no-msan no-rc5 no-sctp no-ssl-trace no-ssl3 no-ssl3-method no-ubsan no-unit-test no-weak-ssl-ciphers no-zlib no-zlib-dynamic",
  perl_archname => "amd64-freebsd",
  perl_cmd => "/home/rs/perl/5.32/bin/perl",
  perl_version => "5.32.1",
  perlargv => [ "BSD-x86_64", "--prefix=/home/azurefennec478/usr/local/openssl1.1.1l", "--openssldir=/home/azurefennec478/usr/local/openssl1.1.1l" ],
  perlenv => {
      "AR" => undef,
      "ARFLAGS" => undef,
      "AS" => undef,
  ...
  prefix => "/home/azurefennec478/usr/local/openssl1.1.1l",
  processor => "",
